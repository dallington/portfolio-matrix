...
import { motion, useSpring, useMotionValue, useScroll, useTransform, useVelocity } from 'framer-motion';
...
export const CustomCursor = () => {
  ...
  return (
    ...
    >
      ...
      <svg width="40" height="40" className="absolute -top-5 -left-5 -rotate-90">
        <circle
          cx="20"
          cy="20"
          r={radius}
