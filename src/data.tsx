...
export const Icons = {
	...
	Node: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M12 0L3.5 4.9v10.2L12 20l8.5-4.9V4.9L12 0zm6.5 14.1l-6.5 3.8-6.5-3.8V5.9l6.5-3.8 6.5 3.8v8.2z" />
		</svg>
	),
	Database: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M12 2c4.418 0 8 1.119 8 2.5s-3.582 2.5-8 2.5-8-1.119-8-2.5 3.582-2.5 8-2.5zm0 17.5c-4.418 0-8-1.119-8-2.5v-2.529c1.664 1.151 4.67 1.862 8 1.862s6.336-.711 8-1.862v2.529c0 1.381-3.582 2.5-8 2.5zm0-5c-4.418 0-8-1.119-8-2.5v-2.529c1.664 1.151 4.67 1.862 8 1.862s6.336-.711 8-1.862v2.529c0 1.381-3.582 2.5-8 2.5zm0-5c-4.418 0-8-1.119-8-2.5v-2.529c1.664 1.151 4.67 1.862 8 1.862s6.336-.711 8-1.862v2.529c0 1.381-3.582 2.5-8 2.5z" />
		</svg>
	),
	Cloud: (
		<svg
			...
			className="w-5 h-5"
		>
			<path d="M17.5 19a5.5 5.5 0 0 0 1-10.9A7.5 7.5 0 0 0 4 11.5A4.5 4.5 0 0 0 4.5 20h11a.5.5 0 0 0 .5-.5z" />
		</svg>
	),
	Redis: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M12 1L3 5.5V18.5L12 23L21 18.5V5.5L12 1ZM19 17.1L12 20.6L5 17.1V6.9L12 3.4L19 6.9V17.1Z" />
		</svg>
	),
	Docker: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M13.962 8.893c0-.303.247-.55.55-.55h2.251c.302 0 .55.247.55.55v2.251c0 .302-.248.55-.55.55h-2.251c-.303 0-.55-.248-.55-.55V8.893zm-3.376 0c0-.303.247-.55.55-.55h2.251c.303 0 .55.247.55.55v2.251c0 .302-.247.55-.55.55H11.136c-.303 0-.55-.248-.55-.55V8.893zm-3.376 0c0-.303.247-.55.55-.55h2.251c.303 0 .55.247.55.55v2.251c0 .302-.247.55-.55.55H7.76c-.303 0-.55-.248-.55-.55V8.893zm-3.376 0c0-.303.247-.55.55-.55h2.251c.303 0 .55.247.55.55v2.251c0 .302-.247.55-.55.55H4.384c-.303 0-.55-.248-.55-.55V8.893z" />
		</svg>
	),
	PHP: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M12.8 5.7c.3-.1.6-.1.8 0 .2.1.4.3.5.5l.6 1.7c.2.6.4 1.1.7 1.6.3.5.7.9 1.1 1.2.4.3.9.5 1.5.7l1.7.5c.3.1.5.3.6.5.1.2.1.5 0 .7-.1.2-.3.4-.5.5l-1.7.6c-.6.2-1.1.4-1.6.7-.5.3-.9.7-1.2 1.1-.3.4-.5.9-.7 1.5l-.5 1.7c-.1.3-.3.5-.5.6-.2.1-.5.1-.7 0-.2-.1-.4-.3-.5-.5l-.6-1.7c-.2-.6-.4-1.1-.7-1.6-.3-.5-.7-.9-1.1-1.2-.4-.3-.9-.5-1.5-.7l-1.7-.5c-.3-.1-.5-.3-.6-.5-.1-.2-.1-.5 0-.7.1-.2.3-.4.5-.5l1.7-.6c.6-.2 1.1-.4 1.6-.7.5-.3.9-.7 1.2-1.1.3-.4.5-.9.7-1.5l.6-1.7c0-.2.2-.4.4-.5z" />
		</svg>
	),
	Laravel: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M8.2 17.5c-.7 0-1.4-.2-1.9-.7l-4.5-5c-.4-.5-.4-1.2 0-1.7l4.5-5c.6-.6 1.4-.8 2.2-.5 1.1.3 1.7 1.5 1.3 2.6l-2.4 2.8 2.4 2.8c.4 1.1-.2 2.3-1.3 2.6-.1.1-.2.1-.3.1zm7.6 0c-.1 0-.2 0-.3-.1-1.1-.3-1.7-1.5-1.3-2.6l2.4-2.8-2.4-2.8c-.4-1.1.2-2.3 1.3-2.6.8-.3 1.6 0 2.2.5l4.5 5c.4.5.4 1.2 0 1.7l-4.5 5c-.7.5-1.4.7-1.9.7z" />
		</svg>
	),
	Vue: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
	...
	Nuxt: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M2.5 19H21C21.6 19 22 18.6 22 18V6C22 5.4 21.6 5 21 5H2.5C1.9 5 1.5 5.4 1.5 6V18C1.5 18.6 1.9 19 2.5 19Z" />
		</svg>
	),
	Astro: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M12.9 20h2.7l.9-1.3c.7-1 1.7-1.7 2.8-2h1.3L15.4 7c-.6-1.2-2.2-1.2-2.8 0L7.4 16.7h1.3c1.1.3 2.1 1 2.8 2l.9 1.3h2.7L22 4H2l10.9 16z" />
		</svg>
	),
	MongoDB: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
	...
	ReactNative: (
		<svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
			<path d="M12 21.6c-2.4 0-4.6-.8-6.4-2.2-.6-.5-.5-1.3.1-1.7.5-.4 1.3-.4 1.8 0 1.4 1.1 3.1 1.7 5 1.7s3.6-.6 5-1.7c.5-.4 1.3-.4 1.8 0 .6.4.7 1.2.1 1.7-1.8 1.4-4 2.2-6.4 2.2zM12 2.4c2.4 0 4.6.8 6.4 2.2.6.5.5 1.3-.1 1.7-.5.4-1.3.4-1.8 0-1.4-1.1-3.1-1.7-5-1.7s-3.6.6-5 1.7c-.5.4-1.3.4-1.8 0-.6-.4-.7-1.2-.1-1.7C6.4 3.2 9.6 2.4 12 2.4zM2.4 12c0-2.4.8-4.6 2.2-6.4.5-.6 1.3-.5 1.7.1.4.5.4 1.3 0 1.8-1.1 1.4-1.7 3.1-1.7 5s.6 3.6 1.7 5c.4.5.4 1.3 0 1.8-.6.6-1.2.7-1.7.1-1.4-1.8-2.2-4-2.2-6.4zM21.6 12c0 2.4-.8 4.6-2.2 6.4-.5.6-1.3.5-1.7-.1-.4-.5-.4-1.3 0-1.8 1.1-1.4 1.7-3.1 1.7-5s-.6-3.6-1.7-5c-.4-.5-.4-1.3 0-1.8.6-.6 1.2-.7 1.7-.1 1.4 1.8 2.2 4 2.2 6.4zM12 6c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z" />
		</svg>
	),
	CICD: (
		<svg
			...
			className="w-5 h-5"
		>
			<path d="M6 9a6 6 0 1 0 12 0A6 6 0 0 0 6 9v8a6 6 0 1 0 12 0A6 6 0 0 0 6 17Z" />
			<path d="M12 3v18" />
		</svg>
	),
};
...
export const RESUME_SUMMARY =
	"Senior Fullstack Engineer with a decade of experience building end-to-end systems. Expert in architecting high-frequency event-driven backends and ultra-responsive frontend layers that communicate via robust, type-safe protocols.";
...
export const SKILLS: Skill[] = [
	// Fullstack & Systems
	{
		...
		level: 98,
		category: "backend",
		subcategory: "NestJS / Express / Hono",
		years: 10,
		icon: Icons.Node,
	},
	{
		...
		level: 95,
		category: "backend",
		subcategory: "Enterprise Architectures",
		years: 8,
		icon: Icons.Laravel,
	},
	...
	// Frontend & UI
	{
		...
		level: 98,
		category: "frontend",
		subcategory: "Server Components & State",
		years: 9,
		icon: Icons.React,
	},
	{
		...
		level: 94,
		category: "frontend",
		subcategory: "Mobile Cross-Platform",
		years: 5,
	...
	},
	{
		...
		level: 92,
		category: "frontend",
		subcategory: "Reactive Interfaces",
		years: 6,
		icon: Icons.Vue,
	},
	{
		...
		level: 90,
		category: "frontend",
		subcategory: "Islands Architecture",
		years: 3,
		icon: Icons.Astro,
	},
	{
	...
	// Data & Infrastructure
	{
		...
		level: 94,
		category: "backend",
		subcategory: "Schema & Optimization",
		years: 9,
		icon: Icons.Database,
	},
	{
	...
	},
	{
		...
		level: 92,
		category: "devops",
		subcategory: "GitHub Actions / CircleCI",
		years: 6,
		icon: Icons.CICD,
	},
	{
